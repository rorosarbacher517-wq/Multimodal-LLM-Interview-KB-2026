...
## D. Vision Backbones / Pretraining
...
## E. Detection / Segmentation / Grounding
- YOLO official docs — https://docs.ultralytics.com/models/
...
具体层数、参数或 2026 新版本信息，回 primary source 核对，不凭印象回答。
