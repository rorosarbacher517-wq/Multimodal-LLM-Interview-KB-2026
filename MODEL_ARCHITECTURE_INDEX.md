...
1. [Transformer / LLM architectures](./01_Transformer_LLM_Fundamentals/ARCHITECTURES_AND_DIMENSIONS.md)
2. [Vision backbones & visual pretraining](./02A_Vision_Backbones_Pretraining/ARCHITECTURES_AND_DIMENSIONS.md)
3. [Detection / segmentation / grounding](./02B_Detection_Segmentation_Grounding/31_architectures_dimensions_innovations.md)
4. [OCR / Document AI](./02C_OCR_Document_AI/16_architectures_dimensions_innovations.md)
5. [Pose / tracking / motion](./02D_Pose_Tracking/19_architectures_dimensions_innovations.md)
6. [Depth / 3D perception / geometry](./02E_Depth_3D_Perception/25_architectures_dimensions_innovations.md)
7. [Multimodal core + representative VLM / Omni models](./04_Representative_Models_2026/ARCHITECTURES_AND_DIMENSIONS.md)
8. [Generative / diffusion / world-model architectures](./03B_Multimodal_Generation_World_Models/ARCHITECTURES_AND_DIMENSIONS.md)
9. [Speech / audio architectures](./08A_Speech_Audio_Fundamentals/ARCHITECTURES_AND_DIMENSIONS.md)
...
The supplement covers concrete model families named in the repository, including Transformer/LLM, ResNet/ViT/Swin/ConvNeXt, CLIP/DINO/MAE/SigLIP, YOLO/DETR/SAM/GroundingDINO, OCR/Document models, pose/tracking models, depth/3D models, Flamingo/BLIP-2/LLaVA and 2026 representative VLM/Omni models, VAE/VQ-VAE/Diffusion/DiT/MMDiT, Whisper/wav2vec 2.0 and related speech models.

Algorithms or protocols such as NMS, IoU, CTC itself, RAG, MCP and A2A are **not treated as standalone neural-network models**. They stay in their original conceptual modules.
